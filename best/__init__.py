...
Usage:
    python best/run.py                      # subset-500 bench on ref/ (defaults = the record run)
    python best/run.py --max-samples 64     # quick smoke
    python best/run.py --split test.other --max-samples 0   # full set
"""
